...
async def get_thumb(videoid):
    ...
    font = ImageFont.truetype("ReoMusic/assets/font.ttf", 30)
    title_font = ImageFont.truetype("ReoMusic/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("ReoMusic/assets/play_icons.png")
